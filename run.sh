...
export LD_LIBRARY_PATH=$THIRD_PARTY/opencv-4.5.4_video/build/install/lib:$THIRD_PARTY/ZLMediaKit/install/lib:/home/ubuntu/wtwei/work/code/zlmediakit_ffmpeg/build:/home/ubuntu/wtwei/work/code/object_detect/build:$THIRD_PARTY/FFmpeg-n6.0/install/lib:$LD_LIBRARY_PATH
...
./build/VideoDecoder rtsp_file.txt 2
